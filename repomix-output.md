...
Generated by Repomix on: 2025-05-28 21:40:52
...
<head>
    ...
    <style>
        ...
        /* Ensure stamina is centered on mobile devices */
        body.is-mobile #stamina-bar {
            bottom: calc(env(safe-area-inset-bottom, 0px) + 10px); /* Closer to bottom + safe area */
            left: 50%;
            transform: translateX(-50%);
            right: auto;
        ...
        body.is-mobile #stamina-bar {
             /* bottom is already defined above, this keeps it consistent */
        }

        @media (orientation: landscape) {
            body.is-mobile #stamina-bar {
                bottom: calc(env(safe-area-inset-bottom, 0px) + 5px) !important; /* Even closer for landscape */
                min-width: 180px !important; /* Slightly wider in landscape */
                 padding: 4px 8px !important;
            }

            body.is-mobile #mobile-combined-ui {
                min-width: auto !important; /* Allow to shrink more */
                padding: 5px 10px !important; /* Reduced padding */
                font-size: 10px !important; /* Smaller font */
                border-radius: 6px !important;
            }
            body.is-mobile #mobile-combined-ui #mobile-timer-display {
                font-size: 12px !important; /* Smaller timer display */
            }
            body.is-mobile #mobile-combined-ui #mobile-sheep-count {
                font-size: 9px !important; /* Smaller sheep count */
            }
             body.is-mobile #mobile-combined-ui #mobile-best-time {
                font-size: 8px !important; /* Smaller best time */
            }
        }
        ...
        @media (max-width: 768px) and (orientation: portrait) {
            body.mobile-fullscreen #stamina-bar {
                 bottom: calc(env(safe-area-inset-bottom, 0px) + 60px) !important; /* Adjust for joystick/sprint buttons */
            }
        }
        ...
        @media (max-width: 768px) and (orientation: landscape) {
            body.mobile-fullscreen #stamina-bar {
                bottom: calc(env(safe-area-inset-bottom, 0px) + 5px) !important; /* Keep close to bottom */
