...
> Drafted 2026-05-10 after Cycle 33 (`operational-hardening`) closed. Cold-start agents: read [`../NEXT_SESSION.md`](../NEXT_SESSION.md) first, then this doc top-to-bottom. Prior cycle plans live in [`archive/cycles/`](archive/cycles/).

> **STUB.** This cycle has a design-doc dependency. Read [`mp-island-scenes-design.md`](mp-island-scenes-design.md) (shipped in Cycle 33 Phase 5) before filling in the Goal paragraph or phases. The design doc's "Suggested Cycle 34 phase shape" section (5 phases, ~7.5hr engineering) is the starting point and answers Q1–Q6 with author leans.
