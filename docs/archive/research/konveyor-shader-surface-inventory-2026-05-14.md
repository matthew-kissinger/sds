...
input. Production water and terrain wiring remain deferred until scene binding
and screenshot proof cover the shipped island scenes. GLB material ownership proof now shows that tree LOD0/LOD1
