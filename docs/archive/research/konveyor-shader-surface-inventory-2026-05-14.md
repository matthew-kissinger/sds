...
loaded from the real Rolling Hills heightfield. Production water wiring remains
deferred until the scene binding and screenshot proof cover the shipped island
scenes. GLB material ownership proof now shows that tree LOD0/LOD1
