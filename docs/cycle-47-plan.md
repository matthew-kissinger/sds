...
> Drafted 2026-05-29 after Cycle 46 closed. Cold-start agents: read [`../NEXT_SESSION.md`](../NEXT_SESSION.md) first, then this doc top-to-bottom. Prior cycle plans live in [`archive/cycles/`](archive/cycles/).
...
(Stub: this is the second half of the approved entrance + UI split. Cycle 46 shipped the zen-boids entrance and cleanup; Cycle 47 is the UI foundation overhaul. The entrance/UI research spike is at [`../cycle45-validation/entrance-ui-spike.md`](../cycle45-validation/entrance-ui-spike.md). Fill in Goal + Phases from the spike before running `/cycle-start`.)
