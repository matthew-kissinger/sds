...
> Scaffolded 2026-07-25 at the Cycle 113 close. Fill in Goal + Phases from the roadmap's 114 section before starting. Cold-start agents: read [`../NEXT_SESSION.md`](../NEXT_SESSION.md) first, then this doc top-to-bottom. Prior cycle plans live in [`archive/cycles/`](archive/cycles/).
