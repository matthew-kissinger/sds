...
- [`docs/cycle-24-research-mp-testing.md`](cycle-24-research-mp-testing.md) — Playwright two-tab patterns, Browserbase tradeoff (skip), reconnect-grace empirics, 5 risk-driven specs
- [`docs/cycle-24-research-foliage.md`](cycle-24-research-foliage.md) — agargaro octahedral-impostor candidate, RiLoD academic SOTA, Ghost of Yōtei tech deep-dive, occluder-fade idiom literature
- [`docs/cycle-24-research-batched-webgpu.md`](cycle-24-research-batched-webgpu.md) — BatchedMesh status (no movement since May 2026), Safari 26 WebGPU, Codrops False Earth as compute-grass reference
