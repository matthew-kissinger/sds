...
| [`cycle-40-plan.md`](cycle-40-plan.md) | Reference / Explanation | Cycle 40 closeout: sun/water/cloud coherence from the atmosphere sun color, plus the lab-only Pixel Forge v2 octahedral tree-impostor route. |
