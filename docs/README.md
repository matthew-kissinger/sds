...
| [`cycle-39-plan.md`](cycle-39-plan.md) | Reference / Explanation | Active Cycle 39 (stub - needs Goal + Phases). Seed scope from Cycle 38 carryover: octahedral tree-impostor sidecar v2 + Kiln material projection, OR a paired mobile-readiness cycle for Phases 5/6. |
