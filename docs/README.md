...
| [`cycle-41-plan.md`](cycle-41-plan.md) | Reference / Explanation | Cycle 41: WebGPU painterly parity and polish after the sun/water side-by-side review. Local acceptance is complete; release commit/tag/deploy remains pending. |
