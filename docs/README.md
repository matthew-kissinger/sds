...
2. **The active cycle plan** — path is in NEXT_SESSION when a cycle is open. No active numbered cycle is open right now; NEXT_SESSION currently names the recommended Steam/desktop store-prep intake.
