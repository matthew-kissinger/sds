...
1. **Prose hygiene.** `grep -c '—'` zero across any prose this cycle touches; no exclamation marks; no "three islands."
...
- When Phase 4 ships, then `grep -rc '—'` over this cycle's touched prose files shall return 0.
