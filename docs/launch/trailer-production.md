...
The owner's fourth review cut is a warm, 42.5-second introduction to being a
...
new exports restore the recorded game ambience and effects from the earlier
real-time takes beneath the corresponding retakes. This is an edited sound
layer, not simultaneous offline audio capture. It fades from 37.5 to 39.5
seconds, excluding the later sound the owner disliked. The final 0.35 seconds
of the selected master and teaser are digital silence. The earlier sound's
source was not independently identified. Owner listening decides the result.

Review: http://127.0.0.1:5488/?revision=4

Outputs: ignored `captures/trailer/deliverables/`, with `sheepdog-sim-v4-*.mp4`
filenames. The selected upload is `sheepdog-sim-v4-C-bossa-piano.mp4`.
...
| Ending | Go directly from the completed herd to the game title and playable address, holding the final completion frame beneath the card. The brief flyover was removed at the owner's request. |
