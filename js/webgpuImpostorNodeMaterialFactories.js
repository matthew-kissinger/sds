...
import { createWebGpuKilnImpostorNodeMaterial } from './webgpuKilnImpostorNodeMaterial.js';
...
export function createWebGpuImpostorNodeMaterialFactories(webGpuModules, options = {}) {
  ...
  return {
    createKilnImpostorMaterial: (context = {}) => {
      ...
      return createWebGpuKilnImpostorNodeMaterial(webGpuModules, {
        layoutName,
