...
function ModeIcon({ type, color, size = 24 }) {
    ...
    const icons = {
        ...
        gamepad: createElement('svg', iconProps, [
            createElement('rect', { key: '1', x: '2', y: '6', width: '20', height: '12', rx: '2' }),
            createElement('circle', { key: '2', cx: '8', cy: '12', r: '2' }),
            createElement('path', { key: '3', d: 'M15 9v6' }),
            createElement('path', { key: '4', d: 'M18 12h-6' })
        ])
    };
