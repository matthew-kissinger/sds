...
export function PointerTour({ isMobile = false }) {
    ...
    return createElement('div', {
        ...
        style: {
            ...
            animation: 'sds-pointer-tour-fadein 0.4s ease-out, sds-pointer-tour-fadeout 0.6s ease-in 4.4s forwards',
        },
    }, [
        createElement('div', {
            key: 'panel',
        ...
        }, gestures.map((g, i) => createElement('div', {
            key: i,
            ...
            }, g.keys.map((k) => createElement('span', {
                key: k,
                style: {
                    minWidth: '1.6rem',
        ...
        createElement('style', {
            ...
            dangerouslySetInnerHTML: {
                __html: [
                    '@keyframes sds-pointer-tour-fadein {',
                    '  from { opacity: 0; transform: translateY(8px); }',
                    '  to   { opacity: 1; transform: translateY(0); }',
                    '}',
                    '@keyframes sds-pointer-tour-fadeout {',
                    '  to { opacity: 0; }',
                    '}',
                ].join('\n')
            }
