/**
 * Cycle 51 P1: one icon system for the bake-off. Semantic names route to a
 * single source, so skins write <Icon name="play" /> and never re-draw a path.
 ...
 * centralized here. This is the "real icon system" the redesign calls for,
 * replacing the duplicated inline SVG paths in the old HUD.
 */
...
function SheepGlyph({ size, color }: { size: number; color: string }) {
  ...
  // every sheep-count readout across skins.
  return (
