...
export function createWebGpuAnimeWaterNodeMaterial(
  ...
  const colorWithFoam = mix(baseColor, vec3(...colorArray(water.foamColor)).mul(water.foamScale), foamBand);
  ...
  material.userData.webgpuWaterFogStrength = water.fogStrength ?? 0.10;
  ...
  material.userData.webgpuWaterColorTint = colorTint;
