...
export function createWebGpuSunBillboardNodeMaterial({ MeshBasicNodeMaterial, AdditiveBlending, Color, TSL }, sun = {}) {
  ...
  material.name = 'webgpu-node-sun-billboard';
  ...
  material.userData.webgpuIntensityUniform = intensity;
  material.userData.webgpuCoreColorUniform = coreColor;
  material.userData.webgpuSunBillboardOwnership = {
    owns: 'disc-body-only',
    skyOwns: 'painted-sun-body-aureole-and-horizon-glow',
  };
  material.userData.webgpuSunBillboardShape = {
    coreRadius,
    coreFeather,
    hotCoreRadius,
    hotCoreFeather,
