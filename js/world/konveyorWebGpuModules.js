...
export function setKonveyorWebGpuModules(modules) {
    cached = modules ?? null;
    if (typeof window !== 'undefined') window.__sdsKonveyorWebGpuModules = cached;
}

export function getKonveyorWebGpuModules() {
    if (cached) return cached;
    if (typeof window !== 'undefined' && window.__sdsKonveyorWebGpuModules) {
        cached = window.__sdsKonveyorWebGpuModules;
    }
    return cached;
}
