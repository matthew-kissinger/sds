...
const ALLOWLIST: Record<string, readonly string[]> = {
  // Post-launch upkeep Phase B (2026-06-09) translated every remaining
  // allowlisted key in all four locales (counting/survival boards, Insane and
  // Chaos modes, Just Play, public lobbies, save-clip, and the pt-only
  // sandbox.* gap). The ratchet hit zero; keep it there. Earlier shrinks:
  // [P1-TUTORIAL] tutorial.*, [P1-SETTINGS-PANEL] settings.*.
  es: [],
  ja: [],
  pt: [],
  'zh-CN': [],
