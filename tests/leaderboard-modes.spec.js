...
describe('leaderboardModesForScene', () => {
    it('shows per-scene solo count tabs for Sheep Dog Island plus its multiplayer modes', () => {
    ...
    it('shows solo count tabs for Open Country without exposing unsupported competitive MP', () => {
    ...
    it('keeps Home Field solo count tabs and all legacy multiplayer modes', () => {
