 ...
 *
 * WHY A TUFT AND NOT A BLADE. spec/05 asks for brushstroke masses rather than
 ...
 * scatter: the placements are baked (spec/04), and what is built here is one
 ...
 * failure spec/05 names. At full sky normal the whole meadow is one flat tone.
