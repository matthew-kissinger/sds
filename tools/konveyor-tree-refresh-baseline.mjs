...
const outPath = process.argv[2] ?? 'cycle36-validation/runtime/tree-refresh-baseline.json';
...
writeFileSync(resolve(ROOT, outPath), `${JSON.stringify(baseline, null, 2)}\n`);
console.log(JSON.stringify({ ok: true, outPath, activeTreeIds, totals }));
