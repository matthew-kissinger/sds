...
<main><header><div class="eyebrow">Sheepdog Sim · Launch media</div><h1>A little time in the field.</h1><p class="sub">Piano bossa · Full-frame retakes, smoother motion, and a quiet ending.</p></header>
<video id="film" controls playsinline preload="metadata" poster="thumbnail-v3.jpg" src="sheepdog-sim-v3-C-bossa-piano.mp4"></video>
...
<a id="download" class="download" href="sheepdog-sim-v3-C-bossa-piano.mp4" download>Download this cut</a><a class="download" href="sheepdog-sim-v3-teaser-15s.mp4" download>15-second teaser · piano bossa</a><p id="credit"></p>
